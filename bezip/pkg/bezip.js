...
* @returns {Uint8Array}
*/
export function process(compressed_data) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(compressed_data, wasm.__wbindgen_export_0);
...
export function decompress(src, pwd, f) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(pwd, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
...
export function compress(entries, datas) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArrayJsValueToWasm0(entries, wasm.__wbindgen_export_0);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayJsValueToWasm0(datas, wasm.__wbindgen_export_0);
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('bezip_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
